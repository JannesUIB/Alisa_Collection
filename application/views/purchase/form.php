					...
					<div class="">
						<form>
							<div class="form-group">
								<input type="text" class="form-control" placeholder="Purchase Order ID" style="border-top:0px solid black;border-right:0px solid black;border-left:0px solid black;height:80px;font-size:24px; width:50%">
							</div>
							<div class="form-group">
								<Label>Vendor</label>
								<input type="text" class="form-control" placeholder="Vendor Name" style="border-top:0px solid black;border-right:0px solid black;border-left:0px solid black;width:30% ">
							</div>
				...
				<div class="col">
					<div class="d-flex flex-row-reverse">
						<table class="table table-sm table-borderless">
							...
							<tr>
								<td  class="text-right"><h5>Purchase Total</h5></td>
								<td style="width:1%;">:</td>
								<td>0</td>
							</tr>
						</table>
