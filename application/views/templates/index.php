...
<head>
    ...
    <title>Ailisa Collection</title>
    <link rel="canonical" href="https://www.wrappixel.com/templates/adminwrap-lite/" />
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../xampp/htdocs/xampp/htdocs/codeigniter_jannes/application/assets/images/favicon.png">
    <!-- Bootstrap Core CSS -->
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="<?php echo site_url('Welcome'); ?>" aria-expanded="false"><i
                                    class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo site_url('Sales/index'); ?>" aria-expanded="false"><i
                                    class="fa fa-usd"></i><span class="hide-menu">Sales</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo site_url('Purchase/index'); ?>" aria-expanded="false"><i
                                    class="fa fa-shopping-cart"></i><span class="hide-menu">Purchase</span></a>
                        </li>
                    ...
                    <div class="col-lg-8">
						<div class="card w-100">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="card-title">Last 5 Sales</h5>
                                    </div>
                                    <div class="ms-auto">
                    ...
                    <div class="col-lg-8 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="card-title">Last 5 Purchase</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <select class="form-select b-0">
                                            <option selected="">January</option>
