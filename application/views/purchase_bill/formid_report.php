...
<html lang="en">
	...
	<body>
		...
		<div class="d-flex flex-row">
			...
			<div class="p-2"><a class="btn btn-secondary" id="print_button" style="width:180px;text-decoration:none;" href="<?php echo site_url('PurchaseBill/formselectedid/'. $rec->ID); ?>">Back To Purchase Bill</a></div>
		</div>
		<div class="container" style="height:100vh; padding:20px;" id="content">
			...
			<div class="row">
				<div class="col d-flex flex-row">
					<h4>Vendor Name</h4>
					<h4>:</h4>
					<h4><?php echo $rec->Vendor ?></h4>
				</div>
			</div>
			<div class="row">
				<div class="col d-flex">
					<h4>Purchase Bill Name</h4>
					<h4>:</h4>
					<h4><?php echo $rec->Purchase_Bill_Name ?></h4>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-6 d-flex">
					<h4>Purchase ID</h4>
					<h4>:</h4>
					<h4><?php echo $rec->Purchase_ID ?></h4>
				</div>
			</div>
			<div class="row">
				<div class="col">
	...
	<script>
		...
		html2pdf().from(element).save('PurchaseBills.pdf');
		});
	</script>
