			...
			<div class="row shadow p-3 mb-5 bg-white rounded">
				<div class="col">
					<table class="table table-sm table-borderless">
						<tr>
							<td><h1 class="text-muted">Inventory</h1></td>
						</td>
						<tr>
							<td>
								<div class="d-flex flex-row" style="margin:0;padding:0;">
									<div class="p-2"><a href="https://localhost/codeigniter_jannes/index.php/Inventory/Form"><button type="button" class="btn btn-warning" style="width:90px;">Create</button></a></div>
								</div>
							</td>
						</tr>
					</table>
