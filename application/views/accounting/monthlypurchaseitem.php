			...
			<div class="row">
				<div class="col">
					<div class="report d-flex flex-column justify-content-center align-items-center" style="padding-top:5px;">
						<h1>Alisia Collection's Monthly Sales Items Report</h1>
						<table id="example" class="table table-bordered">
							...
							<tbody>
								<?php foreach($purchase_order_line_record as $sol){
									echo "<tr>";
									echo "<td>" . $no . "</td>";
									echo "<td>" . $sol->Purchase_Ref . "</td>";
									echo "<td>" . $sol->Item_ID . "</td>";
									echo "<td>" . $sol->Item_Name . "</td>";
									echo "<td>" . $sol->Quantity . "</td>";
									echo "<td>" . $sol->Price . "</td>";
									echo "</tr>";
									$no += 1;
								}
								?>
