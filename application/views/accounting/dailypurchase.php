			...
			<div class="row">
				<div class="col">
					<div class="report d-flex flex-column justify-content-center align-items-center" style="padding-top:5px;">
						<h1>Alisia Collection's Daily Purchase Report</h1>
						<table id="example" class="table table-bordered" style="width:100%">
							...
							<thead>
							<tbody>
							<?php foreach($purchase_record as $sale){
								echo "<tr>";
								echo "<td>" . $no . "</td>";
								echo "<td>" . $sale->ID . "</td>";
								echo "<td>" . $sale->Purchase_Name . "</td>";
								echo "<td>" . $sale->Create_Date . "</td>";
								echo "<td>" . $sale->Purchase_Total . "</td>";
								if ($sale->Status === "RFQ"){
									echo "<td>Request For Quotation</td>";
								}
								else{
									echo "<td>Purchase Order Order</td>";
								}
								echo "</tr>";
								$no += 1;
							}
